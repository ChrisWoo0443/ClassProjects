...
public class ArrayListPracticeLab 
{
	 ...
	 */
	public static ArrayList<String> convertArrayToList(String [] arr1)
	{
	 ...
	 */
	public static int maxLength(ArrayList<String> list1)
	{
		String result = "";
		if(list1.size() == 0)
			return 0;
		else
		{
			...
			{
				if(result.length() < list1.get(i).length())
				{
					result = list1.get(i);
				}
			}
	 ...
	 */
	public static ArrayList<String> swapPairs(ArrayList<String> list1)
	{
		ArrayList<String> newList = new ArrayList<String>();
		newList = list1;
		String hold = "";
		if(list1.size() % 2 != 0)
		{
			...
			{
				hold = newList.get(i);
				newList.set(i, list1.get(i+1));
				newList.set(i+1, hold);
			}
		}
		else
		{
	 ...
	 */
	public static ArrayList<String> removeEvenLength(ArrayList<String> list1)
	{
		ArrayList<String> newList = new ArrayList<String>();
	 ...
	 */
	public static void doubleList(ArrayList<String> list1)
	{
